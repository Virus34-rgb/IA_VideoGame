...
def get_warriors_classes() -> Dict[int, WarriorData]:
    ...
    archer = WarriorData(
        id=2, name="Archer", max_health=27, speed=18,
        ability_pool=[
            ...
            AbilityData("Piercing Shot", 4, 13, [0], 2, EffectType.ATTACK),
    ...
    wizard = WarriorData(
        id=4, name="Wizard", max_health=25, speed=12,
        ability_pool=[
            AbilityData("Magic Missile", 0, 6, [0, 1, 2], 0, EffectType.ATTACK),
            AbilityData("Zap", 1, 12, [1, 2], 1, EffectType.ATTACK),
            AbilityData("FireBall", 2, 9, [0, 1, 2], 1, EffectType.ATTACK),
            AbilityData("StaffAttack", 3, 8, [0], 0, EffectType.ATTACK),
            AbilityData("Frost Nova", 4, 9, [0, 1], 1, EffectType.ATTACK),
            AbilityData("Arcane Surge", 5, 12, [1], 2, EffectType.ATTACK),
        ]
    )

    cleric = WarriorData(
        id=5, name="Cleric", max_health=30, speed=14,
        ability_pool=[
