...
def get_warriors_classes() -> Dict[int, WarriorData]:
    knight = WarriorData(
        ...
        ability_pool=[
            ...
            AbilityData("Slice", 2, 4, [0, 1, 2], 0, EffectType.ATTACK),
    ...
    archer = WarriorData(
        ...
        ability_pool=[
            ...
            AbilityData("Rain", 3, 6, [0, 1, 2], 1, EffectType.ATTACK),
    ...
    rogue = WarriorData(
        ...
        ability_pool=[
            ...
            AbilityData("PoisonGas", 2, 7, [0, 1, 2], 1, EffectType.ATTACK),
            AbilityData("Knife", 3, 8, [0], 0, EffectType.ATTACK),
            AbilityData("Ambush", 4, 12, [0], 2, EffectType.ATTACK),
    ...
    wizard = WarriorData(
        ...
        ability_pool=[
            AbilityData("Magic Missile", 0, 4, [0, 1, 2], 0, EffectType.ATTACK),
            AbilityData("Zap", 1, 8, [1, 2], 1, EffectType.ATTACK),
            AbilityData("FireBall", 2, 7, [0, 1, 2], 1, EffectType.ATTACK),
    ...
    cleric = WarriorData(
        ...
        ability_pool=[
            ...
            AbilityData("Light", 3, 6, [0, 1, 2], 1, EffectType.ATTACK),
            AbilityData("Holy Nova", 4, 9, [0, 1, 2], 2, EffectType.ATTACK),
